                        ...
                        <div className="grid grid-cols-12 gap-4 items-center">
                            ...
                            <div className="col-span-3 flex items-center gap-3 min-w-0">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="font-medium text-gray-900 truncate" title={group.group_name}>{group.group_name}</p>
                                    {group.group_code && (
                                        <p className="text-xs text-gray-500 truncate" title={group.group_code}>{group.group_code}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="col-span-3 min-w-0">
                                <p className="text-sm text-gray-900 truncate" title={group.center?.center_name || group.center_id}>
                                    {group.center?.center_name || group.center_id}
                                </p>
                                {group.center?.CSU_id && (
                                    <p className="text-xs text-gray-500 truncate" title={group.center.CSU_id}>{group.center.CSU_id}</p>
                                )}
                            </div>

                            {/* Branch */}
                            <div className="col-span-2 min-w-0">
                                <p className="text-sm text-gray-900 truncate" title={group.center?.branch?.branch_name || group.branch?.branch_name || 'N/A'}>
