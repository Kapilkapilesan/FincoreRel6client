                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`text-xs font-bold py-1 px-2 rounded-lg ${selectedCustomers.length >= 1 && selectedCustomers.length <= 3 ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'}`}>
