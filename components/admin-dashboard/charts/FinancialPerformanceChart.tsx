        ...
        <div className="w-full">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
                ...
                <div className="flex items-center gap-6 px-4 py-2 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-100 dark:border-gray-800">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">Income</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <Circle className="w-2.5 h-2.5 fill-blue-500 stroke-none" />
                        <span className="text-[10px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">Disbursements</span>
                    </div>
                </div>
            </div>
            ...
            <div className="relative w-full overflow-hidden">
                        ...
                        >
                            ...
                            <text
                                ...
                                className={`text-[9px] font-black uppercase tracking-tighter transition-all duration-300 
                                    ${hoveredIndex === index ? 'fill-gray-900 dark:fill-white' : 'fill-gray-400'}
                ...
                {hoveredIndex !== null && (
                    ...
                    >
                        <div className="bg-gray-900 dark:bg-black text-white px-4 py-3 rounded-2xl shadow-2xl flex flex-col gap-1 min-w-[140px] border border-gray-800">
                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{data[hoveredIndex].month} Statistics</span>
                            ...
                            <div className="absolute top-full left-1/2 -translate-x-1/2 w-3 h-3 bg-gray-900 dark:bg-black rotate-45 -mt-1.5" />
                        </div>
                    </div>
                )}
            </div>
